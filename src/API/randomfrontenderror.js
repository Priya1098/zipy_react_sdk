export function randomfrontenderror() {
  ...
  switch (status) {
    case 1:
        window.zipy.logException(new Error("Hello This is new Eval Error"));

        throw  EvalError();

      
    case 2:
        window.zipy.logException(new Error("Hello This is a new Range Error"));
    ...
    case 4:
        window.zipy.logException(new SyntaxError("Hello This is a new Syntax Error"));
